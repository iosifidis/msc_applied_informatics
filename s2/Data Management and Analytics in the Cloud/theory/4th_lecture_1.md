...
- **Υποστήριξη Τύπου Δεδομένων (Value) (Slide 6):**
  - Η _τιμή (value)_ σε ένα ζεύγος κλειδί-τιμή μπορεί να είναι οτιδήποτε - από μια απλή συμβολοσειρά (string) ή αριθμό, μέχρι πιο σύνθετες δομές.
...
- **Έλλειψη Υποστήριξης ACID (Slide 14):**
  - Για να επιτευχθεί η επεκτασιμότητα, πολλές KV βάσεις **δεν παρέχουν** ενσωματωμένη υποστήριξη για ACID συναλλαγές.
