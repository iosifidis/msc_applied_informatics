...
1.  **Τύποι Μάθησης (Learning Types):**
    ...
    *   **Μη-Επιβλεπόμενη Μάθηση (Unsupervised Learning):** Εκπαίδευση σε δεδομένα *χωρίς ετικέτες*. Στόχος είναι η εύρεση δομών, μοτίβων ή συνόψεων στα δεδομένα.
        ...
        *   **Μείωση Διάστασης (Dimensionality Reduction):** Μείωση του αριθμού των χαρακτηριστικών (π.χ., PCA, Autoencoders - Ε7, Ε19 ΜΜ, Ε8 ΝΝ). Στόχος: αποφυγή "κατάρας της διάστασης" (curse of dimensionality), μείωση θορύβου, ταχύτερη εκπαίδευση, οπτικοποίηση.
