...
1. Προσδιορίστε τις ορθογώνιες διαστάσεις στις τάξεις σας. Αυτές οι ανεξάρτητες έννοιες θα μπορούσαν να είναι: αφαίρεση/πλατφόρμα, τομέας/υποδομή, front-end/back-end ή διεπαφή/υλοποίηση.   
...
Το Bridge είναι ένα δομικό σχέδιο σχεδιασμού που χωρίζει την επιχειρηματική λογική ή την τεράστια τάξη σε ξεχωριστές ιεραρχίες κλάσεων που μπορούν να αναπτυχθούν ανεξάρτητα.
