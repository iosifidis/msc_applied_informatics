...
public class PayrollMain {
	...
	public static void main(String[] args) {
		...
		c.addEmployee(new Employee("Developer",                      // Assumption-1: Employees are unique by name
				"perHour", "AA", 15));                               // Assumption-2: The set hours are overall (not by project)
		c.addEmployee(new Employee("Analyst", 
				"Salary", "BB", -1));
		c.addEmployee(new Employee("Manager", 
				"Salary", "CC", -1));
