...
public class PayrollMain {
	...
	public static void main(String[] args) {
		...
		*/
		...
		c.addEmployee(new Developer(new PerHour(15),"AA")); // Assumption-1: Employees are unique by name
				                                          // Assumption-2: The set hours are overall (not by project)
		c.addEmployee(new Analyst(new WithSalary(), "BB"));
		c.addEmployee(new Manager(new WithSalary(), "CC"));
